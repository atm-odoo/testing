...
class WooProductTemplateEpt(models.Model):
    ...
    is_virtual_product = fields.Boolean('Is Virtual Product?', copy=False, help="It is used to identify that product is virtual.")
        ...
        for template in woo_variable_products:
            ...
            if variations:
                ...
                for woo_variants in variant_batches:
                    ...
                    res = wc_api.post('products/%s/variations/batch' % template.woo_tmpl_id, {'update': woo_variants})
    ...
    def woo_published(self):
        ...
        if self.woo_tmpl_id:
            data = {'status': 'publish'}
            res = wc_api.put('products/%s' % self.woo_tmpl_id, data)
