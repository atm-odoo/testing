...
class SaleOrder(models.Model):
    ...
    def woo_prepare_tax_data(self, tax_line_data, rate_percent, woo_taxes):
        """
        ...
        for order_tax in tax_line_data:
            ...
            if rate_percent == "available":
                ...
                woo_taxes = self.get_tax_ids(self.woo_instance_id, order_tax.get('rate_id'), woo_taxes)
        return woo_taxes
    ...
    def create_woo_orders(self, queue_lines, common_log_book_id):
        ...
        for queue_line in queue_lines:
            ...
            woo_taxes = sale_order.woo_prepare_tax_data(order_data.get('tax_lines'), rate_percent, woo_taxes)
    ...
    def woo_create_extra_lines(self, order_data, tax_included, woo_taxes):
        ...
        @param rounding: Rounding as per configuration.
        @author: Maulik Barad on Date 04-Nov-2020.
        """
    ...
    def _create_invoices(self, grouped=False, final=False, date=None):
        ...
        for order in self:
            if order.woo_instance_id:
                rounding = bool(order.woo_instance_id.tax_rounding_method == 'round_per_line')
                res += super(SaleOrder,order.with_context(round=rounding))._create_invoices(grouped=grouped,
